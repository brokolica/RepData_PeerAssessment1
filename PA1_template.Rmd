...
```
**Mean** total number of steps taken per day with `NA`s replaced is **`r data3.mean`**, while the **median** has value of **`r data3.median`**. **Sem treba dat este vetu, ze ako sa hodnoty zmenili oproti tomu, ked sme s NA hodnotami neratali!!!!!!!!!!!!!!!!!!!!!!!!**
